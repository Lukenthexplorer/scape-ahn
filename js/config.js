...
const ASSETS = {
  ...
  /* AHN -- procedural placeholder, drawn in art.js, following the look the
   * comic panels establish: dark swept hair, round glasses, huge grin, lanky
   * candy-cane body. Same deal as the obstacles: set `path` to a real sheet
   * (112x176 frames, same 9-frame order) and this whole drawing is bypassed.
   * tools/make_ahn_sheet.py can still build a photo-headed sheet if you ever
   * want it back -- it is just not wired in. */
  ahn: {
    key: 'ahn',
    path: null,
    frameWidth: 112, frameHeight: 176, frameCount: 9, artScale: 2,
    anims: {
...
const PAL = {
  ...
  ahnSkin: '#f0cdae', ahnSkinShade: '#d9ab89', ahnHair: '#1b1224', ahnLens: '#bfe4f2',
